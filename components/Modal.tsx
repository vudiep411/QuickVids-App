              ...
              <form>
                <div className="grid md:grid-cols-2 md:gap-6">
                  ...
                  <div className="relative z-0 mb-6 w-full group">
                    ...
                    <input 
                      className="block w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none dark:placeholder-gray-400" 
                      type="file"
                      accept="image/*"
